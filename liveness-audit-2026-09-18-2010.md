...
**Run:** 2026-09-18 20:16 (Australia/Sydney) | **Entries checked:** 1283 | **Source:** `backend/data/ideasexist.db` (opened read-only)

Every entry in the archive was fetched live, one by one. A plain `200` is not treated as proof of life: each 200 had its body fetched and its `<title>`/copy scanned for parking, for-sale, suspended and bot-challenge markers. Rows that looked anomalous were then re-checked with a second HTTP client and a fresh DNS lookup, so a transient resolver blip or a single 403 is not reported as a death.

Classification

- **LIVE** - resolves and serves the company's own site.
- **DEAD** - HTTP 404/410, a parked / for-sale page, or a bare server default page.
- **REPURPOSED** - returns 200, but the domain now serves unrelated spam, not the company.
- **WALLED** - refused our automated client (403) to both user agents, so life could not be confirmed.
...
- 1267 of 1283 archive entries (98.8%) still serve a live website.
- 9 are dead: two hard 404s and seven parked or domain-for-sale pages.
- 3 domains are still online but no longer belong to the company - they now serve gambling or streaming spam.
- 4 refused our automated client outright, so they are unconfirmed either way.
- 9 stored URLs now redirect to a different domain.

## Dead - needs a human decision

| # | Name | Stored URL | Result | Detail |
|---|---|---|---|---|
| 1223 | Credy | https://www.credy.in/ | **DEAD** | parked / for-sale page - title='Welcome to nginx!' |
...
| 917 | Lula | http://www.lula.is | **DEAD** | parked / for-sale page - title='lula.is' |
| 551 | Pavilion Data | http://paviliondata.com | **DEAD** | parked / for-sale page - title='Paviliondata.com for sale / Spaceship.com' |
| 688 | Rapid Robotics | https://www.atom.com/name/RapidRobotics | **DEAD** | parked / for-sale page - title='RapidRobotics.com - Premium Domain For Sale / Atom' |
| 1256 | Soylent | http://campaign.soylent.me | **DEAD** | parked / for-sale page - title='soylent.me' |
| 1240 | Vidcode | http://vidcode.io | **DEAD** | parked / for-sale page - title='vidcode.io' |
| 1235 | Wicked Ride | https://www.hugedomains.com/domain_profile.cfm?d=wickedride.com | **DEAD** | parked / for-sale page - title='WickedRide.com is for sale / HugeDomains' |

## Domain still online, company gone (repurposed)

| # | Name | Stored URL | Final URL | Detail |
|---|---|---|---|---|
| 1262 | Catalia Health | https://cakhiazvm.tv/ | https://cakhiazac.tv/ | HTTP 200 but the domain now serves a Vietnamese football-streaming page (cakhiazac.tv) |
| 979 | Skydrop | https://aizuriquartet.com/ | https://xoilaczbi.tv/ | HTTP 200 but the domain now serves a Vietnamese football-streaming page (xoilaczbi.tv) |
| 735 | Station | http://getstation.com | https://dinosaurcoffee.com/ | HTTP 200 but the domain now serves a Thai online-gambling page (dinosaurcoffee.com) |

## Walled - alive or dead, we were refused

| # | Name | Stored URL | HTTP | Detail |
|---|---|---|---|---|
| 443 | Magic Eden | https://magiceden.io/ | 403 | HTTP 403 - bot wall / rate limit, cannot confirm |
| 193 | SSENSE | https://www.ssense.com/en-in | 403 | HTTP 403 - bot wall / rate limit, cannot confirm |
| 210 | UNIQLO | https://www.uniqlo.com/in/en/ | 403 | HTTP 403 - bot wall / rate limit, cannot confirm |
| 965 | Weaveworks | https://ambking1234.limo/?action=register&marketingRef=6788b227da9499f55f6ea745 | 403 | HTTP 403 - bot wall / rate limit, cannot confirm |

## Redirected away from the stored domain

| # | Name | Stored host | Final host | State |
|---|---|---|---|---|
| 80 | Carrd | carrd.co | carrd.com | LIVE |
| 1262 | Catalia Health | cakhiazvm.tv | cakhiazac.tv | REPURPOSED |
| 555 | Clari | clari.com | salesloft.com | LIVE |
| 338 | Fieldguide | fieldguide.io | fieldguide.com | LIVE |
| 120 | Hotjar | hotjar.com | contentsquare.com | LIVE |
| 611 | SWORD Health | swordhealth.com | sword.com | LIVE |
| 979 | Skydrop | aizuriquartet.com | xoilaczbi.tv | REPURPOSED |
| 735 | Station | getstation.com | dinosaurcoffee.com | REPURPOSED |
| 965 | Weaveworks | ambking1234.limo | ambking1234.dev | WALLED |

## GitHub-only entries - is there a website in the repo?

14 entries carry no website of their own - the stored URL *is* the GitHub page. Each repo was queried through the GitHub API for its declared `homepage` field, and its README was scanned for an outbound project link.

| # | Name | Repo | Declared homepage | Homepage live? | Best README link |
|---|---|---|---|---|---|
| 238 | Andrej Karpathy Skills | multica-ai/andrej-karpathy-skills | _none declared_ | - |  |
| 33 | Awesome Lists | sindresorhus/awesome | _none declared_ | - | https://sindresorhus.com/supercharge - alive |
| 242 | Claw Code | ultraworkers/claw-code | _none declared_ | - | https://rustup.rs/ - alive |
| 225 | Coding Interview University | jwasham/coding-interview-university | _none declared_ | - | https://www.coursera.org/learn/algorithms-part1/home/week/3 - alive |
| 107 | GitHub |  | _none declared_ | - |  |
| 240 | JavaScript Algorithms | trekhleb/javascript-algorithms | _none declared_ | - | https://trekhleb.dev - alive |
| 231 | Linux | torvalds/linux | _none declared_ | - | https://www.kernel.org/doc/html/latest/ - alive |
| 228 | Project-Based Learning | practical-tutorials/project-based-learning | _none declared_ | - | https://brennan.io/2015/01/16/write-a-shell-in-c/ - alive |
| 268 | Stability AI | Stability-AI/generative-models | _none declared_ | - | https://huggingface.co/stabilityai/sv3d - alive |
| 230 | Superpowers | obra/superpowers | _none declared_ | - | https://claude.com/plugins/superpowers - alive |
| 224 | System Design Primer | donnemartin/system-design-primer | _none declared_ | - | http://www.slideshare.net/jboner/scalability-availability-stability-pa |
| 233 | The Book of Secret Knowledge | trimstray/the-book-of-secret-knowledge | _none declared_ | - | https://www.google.com - alive |
| 346 | Vocode | vocodedev | vocode.dev - **alive** |  |  |
| 9 | Whisper | openai/whisper | _none declared_ | - | https://arxiv.org/abs/2212.04356 - alive |

Wider check: **57** archive entries carry a `github_url`; **45** of those repos declare a `homepage`, and **all 45** resolved live on this run. Archived repos: Gecko.

## Full table

Every checked entry, in name order.
...
| 1232 | Capillary Tech | https://www.capillarytech.com/ | **LIVE** | HTTP 200 |
...
| 1262 | Catalia Health | https://cakhiazvm.tv/ | **REPURPOSED** | HTTP 200 but the domain now serves a Vietnamese football-streaming page (cakhiazac.tv) |
...
| 83 | Cloudflare | https://www.cloudflare.com | **LIVE** | HTTP 200 - HTTP 200; the word 'Cloudflare' in the title is the company's own name |
...
| 1037 | LeafLink | https://www.leaflink.com/ | **LIVE** | HTTP 200 - transient DNS failure on pass 1; resolves and returns 200 to two clients |
...
| 443 | Magic Eden | https://magiceden.io/ | **WALLED** | HTTP 403 - bot wall / rate limit, cannot confirm |
...
| 167 | Product Hunt | https://www.producthunt.com | **LIVE** | HTTP 200 - HTTP 200 to a second client (403 to the default UA only) -- alive behind a soft wall |
...
| 193 | SSENSE | https://www.ssense.com/en-in | **WALLED** | HTTP 403 - bot wall / rate limit, cannot confirm |
...
| 979 | Skydrop | https://aizuriquartet.com/ | **REPURPOSED** | HTTP 200 but the domain now serves a Vietnamese football-streaming page (xoilaczbi.tv) |
...
| 767 | Squire | https://getsquire.com/ | **LIVE** | HTTP 200 - HTTP 200 to a second client (403 to the default UA only) -- alive behind a soft wall |
...
| 735 | Station | http://getstation.com | **REPURPOSED** | HTTP 200 but the domain now serves a Thai online-gambling page (dinosaurcoffee.com) |
...
| 204 | The New York Times | https://www.nytimes.com | **LIVE** | HTTP 200 - HTTP 200 to a second client (403 to the default UA only) -- alive behind a soft wall |
...
| 210 | UNIQLO | https://www.uniqlo.com/in/en/ | **WALLED** | HTTP 403 - bot wall / rate limit, cannot confirm |
...
| 965 | Weaveworks | https://ambking1234.limo/?action=register&marketingRef=6788b227da9499f55f6ea745 | **WALLED** | HTTP 403 - bot wall / rate limit, cannot confirm |
