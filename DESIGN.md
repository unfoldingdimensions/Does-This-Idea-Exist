...
- **Dark — moon night:** the wash sinks from warm charcoal into deep indigo. The moon glow (24vmin, `--sky-moon-glow`) rises ~6vh and brightens (0.8 → 1); 12 deterministic stars (`--sky-star`) fade in 0.15 → 0.9 as night deepens.
